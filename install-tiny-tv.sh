...
sudo apt install -y git python3 python3-pip omxplayer ffmpeg fonts-freefont-ttf screen pulseaudio-module-bluetooth
sudo pip3 install keyboard youtube_dl --force
