...
sudo sed -i '$ a function tiny-tv-test { /home/pi/tiny-tv-venv/bin/python3 /home/pi/tiny-tv/tiny-tv.py "https://www.youtube.com/watch?v=h8NrKjJPAuw" --saveAs "Bugs Bunny.mp4" --category "cartoons" --removeVerticalBars --hue -35; }' ~/.bash_aliases
sudo sed -i '$ a function tiny-tv-test-category { /home/pi/tiny-tv-venv/bin/python3 /home/pi/tiny-tv/tiny-tv.py "category" --category "cartoons" --volume 50 --hue -35; }' ~/.bash_aliases
